...
class StorageTipsCategoryList extends ConsumerWidget {
          ...
          return GestureDetector(
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: ref.watch(tipsCategoryIndexProvider) == index ? Color(0xff575E71) : Color(0xffFAFDFF),
            ...
            onTap: () {
              ...
              ref.read(tipsCategorySelectorProvider.notifier).state= itemsList[index];
            },
          );
        },
      ),
